...
- `trấn kỳ CHỢ NGHIỆN SEO` → Tạo `example. com/?source=CHỢ NGHIỆN SEO&medium=social&campaign=Trấn Kỳ`
- `tk cns` → Tạo liên kết tương tự như trên, nhưng chỉ dùng mã sản phẩm và tên viết tắt
...
👉Link tải: https://tranky.deno.dev/tichhop/cns
