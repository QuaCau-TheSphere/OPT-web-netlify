...
• Ý đồ thiết kế (design rationale)
...
📷Hình 1: Điểm giống và khác của các mô hình học tập
📷Hình 2: Một số nhu cầu công việc ví dụ và những sản phẩm và kiến thức cần có để làm được chúng
