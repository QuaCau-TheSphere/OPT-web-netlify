...
```
Đoạn `G-********` là ID của nó. [[./Một Google tag có thể có nhiều ID|Một Google tag có thể có nhiều ID]]. [[./Nên cài Google tag trong Google Tag Manager thay vì cài trực tiếp trên web hoặc qua plugin|Có thể cài nó trực tiếp trên web, hoặc nhờ plugin hỗ trợ, nhưng tốt nhất là nên cài thông qua Google Tag Manager]].
