...
Nguồn:: [[../../../Ξ Nguồn/Khoa học dữ liệu. Khoa học máy tính/Phạm Đình Khánh|Phạm Đình Khánh]], [Singular Value Decomposition | Kaggle](https://www.kaggle.com/code/phamdinhkhanh/singular-value-decomposition/notebook)

Bới vì [[../Vector/Độ tương đồng của hai vector chính là tích vô hướng vừa nó|Độ tương đồng của hai vector chính là tích vô hướng vừa nó]], nên SVD không làm biến dạng độ tương đồng của chúng
