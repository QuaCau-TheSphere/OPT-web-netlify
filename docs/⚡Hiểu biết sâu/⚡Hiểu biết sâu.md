...
- Khoa học dữ liệu: 
    ...
    - [[./Khoa học dữ liệu/Numpy và Pandas|Numpy và Pandas]]
...
- Khoa học dữ liệu/Phân tích mạng lưới: 
    ...
    - [[./Khoa học dữ liệu/Phân tích mạng lưới/Semantic triplestore|Semantic triplestore]]
...
- Khoa học dữ liệu/Phân tích xu hướng: 
    - [[./Khoa học dữ liệu/Phân tích xu hướng/70% thời gian chỉ là để làm sạch dữ liệu|70% thời gian chỉ là để làm sạch dữ liệu]]
    - [[./Khoa học dữ liệu/Phân tích xu hướng/Các công cụ lắng nghe xã hội có sẵn giống như một ảnh chụp màn hình nhanh về những gì đang diễn ra|Các công cụ lắng nghe xã hội có sẵn giống như một ảnh chụp màn hình nhanh về những gì đang diễn ra]]
    - [[./Khoa học dữ liệu/Phân tích xu hướng/Gensim tập trung vào mô hình chủ đề|Gensim tập trung vào mô hình chủ đề]]
    - [[./Khoa học dữ liệu/Phân tích xu hướng/Không giám sát nghĩa là giả định rằng người huấn luyện không có giả định nào|Không giám sát nghĩa là giả định rằng người huấn luyện không có giả định nào]]
    - [[./Khoa học dữ liệu/Phân tích xu hướng/Tổng quan về mô hình chủ đề|Tổng quan về mô hình chủ đề]]
    - [[./Khoa học dữ liệu/Phân tích xu hướng/Tổng quan về xử lý tiếng Việt|Tổng quan về xử lý tiếng Việt]]
...
- Khoa học dữ liệu/Phân tích xu hướng/Mô hình: 
    - [[./Khoa học dữ liệu/Phân tích xu hướng/Mô hình/Bản chất của mô hình chủ đề là tô màu cho văn bản và từ|Bản chất của mô hình chủ đề là tô màu cho văn bản và từ]]
    - [[./Khoa học dữ liệu/Phân tích xu hướng/Mô hình/Mô hình bản chất là một phép biến đổi không gian vector|Mô hình bản chất là một phép biến đổi không gian vector]]
    - [[./Khoa học dữ liệu/Phân tích xu hướng/Mô hình/Nhân văn số sử dụng mô hình chủ đề rất nhiều|Nhân văn số sử dụng mô hình chủ đề rất nhiều]]
    - [[./Khoa học dữ liệu/Phân tích xu hướng/Mô hình/Mô hình chủ đề  rất hữu dụng cho việc diễn giải|Mô hình chủ đề  rất hữu dụng cho việc diễn giải]]
    - [[./Khoa học dữ liệu/Phân tích xu hướng/Mô hình/SVD ban đầu là để tìm ra một phép xoay không gian mà vẫn giữ nguyên tích vô hướng của các vector|SVD ban đầu là để tìm ra một phép xoay không gian mà vẫn giữ nguyên tích vô hướng của các vector]]
    - [[./Khoa học dữ liệu/Phân tích xu hướng/Mô hình/tf-idf giúp xác định độ quan trọng của một từ trong một văn bản trong bộ văn bản|tf-idf giúp xác định độ quan trọng của một từ trong một văn bản trong bộ văn bản]]

- Khoa học dữ liệu/Phân tích xu hướng/Vector: 
    - [[./Khoa học dữ liệu/Phân tích xu hướng/Vector/Bộ từ trong dictionary sẽ quyết định bộ vector|Bộ từ trong dictionary sẽ quyết định bộ vector]]
    - [[./Khoa học dữ liệu/Phân tích xu hướng/Vector/Vector là một bộ số. Ma trận là một bảng số|Vector là một bộ số. Ma trận là một bảng số]]
    - [[./Khoa học dữ liệu/Phân tích xu hướng/Vector/Việc biểu diễn các từ dưới dạng các vector one-hot chỉ đáp ứng được khả năng huấn luyện mà chưa phản ảnh được mối liên hệ về mặt ngữ nghĩa của các từ|Việc biểu diễn các từ dưới dạng các vector one-hot chỉ đáp ứng được khả năng huấn luyện mà chưa phản ảnh được mối liên hệ về mặt ngữ nghĩa của các từ]]
    - [[./Khoa học dữ liệu/Phân tích xu hướng/Vector/Túi từ không phân biệt được những câu có cùng các từ bởi nó không phân biệt thứ tự trước sau của các từ trong một câu|Túi từ không phân biệt được những câu có cùng các từ bởi nó không phân biệt thứ tự trước sau của các từ trong một câu]]
    - [[./Khoa học dữ liệu/Phân tích xu hướng/Vector/Việc vector hoá các văn bản là để máy tính có thể xử lý được|Việc vector hoá các văn bản là để máy tính có thể xử lý được]]
    - [[./Khoa học dữ liệu/Phân tích xu hướng/Vector/Độ tương đồng của hai vector chính là tích vô hướng vừa nó|Độ tương đồng của hai vector chính là tích vô hướng vừa nó]]
...
- Khoa học máy tính: 
    ...
    - [[./Khoa học máy tính/Lập trình không hoàn toàn chỉ dùng não, mà còn dùng cơ thể|Lập trình không hoàn toàn chỉ dùng não, mà còn dùng cơ thể]]
    - [[./Khoa học máy tính/Lập trình là một cái gì đó thâm nhập vào đời sống của chúng ta, nhưng lại gần như vô hình|Lập trình là một cái gì đó thâm nhập vào đời sống của chúng ta, nhưng lại gần như vô hình]]
    - [[./Khoa học máy tính/Lập trình thực ra là dùng ẩn dụ|Lập trình thực ra là dùng ẩn dụ]]
    - [[./Khoa học máy tính/Lập trình viên biết lập trình chủ yếu là nhờ biết google|Lập trình viên biết lập trình chủ yếu là nhờ biết google]]
    - [[./Khoa học máy tính/Lập trình viên mới thường hỏi về cú pháp, thư viện, hay ngôn ngữ. Lập trình viên nhiều kinh nghiệm thường tập trung vào các khái niệm trừu tượng|Lập trình viên mới thường hỏi về cú pháp, thư viện, hay ngôn ngữ. Lập trình viên nhiều kinh nghiệm thường tập trung vào các khái niệm trừu tượng]]
    - [[./Khoa học máy tính/Người không học về lập trình thấy việc lập trình như làm phép thuật|Người không học về lập trình thấy việc lập trình như làm phép thuật]]
...
- Khoa học máy tính/Hợp tác làm việc: 
    ...
    - [[./Khoa học máy tính/Hợp tác làm việc/Có sự đánh đổi giữa sự dễ dàng tuỳ biến dữ liệu của mình và sự dễ dàng hợp tác qua mạng|Có sự đánh đổi giữa sự dễ dàng tuỳ biến dữ liệu của mình và sự dễ dàng hợp tác qua mạng]]
    - [[./Khoa học máy tính/Hợp tác làm việc/Có sự đánh đổi giữa sự tự do sử dụng dữ liệu và sự tiện lợi trong việc hợp tác|Có sự đánh đổi giữa sự tự do sử dụng dữ liệu và sự tiện lợi trong việc hợp tác]]
...
- Khoa học máy tính/Làm việc với hệ điều hành: 
    - [[./Khoa học máy tính/Làm việc với hệ điều hành/Biến môi trường giúp ta điền những giá trị lặp đi lặp lại nhanh hơn|Biến môi trường giúp ta điền những giá trị lặp đi lặp lại nhanh hơn]]
    - [[./Khoa học máy tính/Làm việc với hệ điều hành/Terminal là thứ để giao tiếp với lõi của hệ điều hành|Terminal là thứ để giao tiếp với lõi của hệ điều hành]]

- Khoa học máy tính/Lập trình hướng đối tượng: 
    - [[./Khoa học máy tính/Lập trình hướng đối tượng/4 đặc điểm của lập trình hướng đối tượng|4 đặc điểm của lập trình hướng đối tượng]]
    - [[./Khoa học máy tính/Lập trình hướng đối tượng/Chưa rõ lý do vì sao lại dịch object ra thành đối tượng chứ không phải vật thể|Chưa rõ lý do vì sao lại dịch object ra thành đối tượng chứ không phải vật thể]]
    - [[./Khoa học máy tính/Lập trình hướng đối tượng/In JavaScript, dictionaries are called objects, whereas, in languages like Python or C, they are called dictionaries|In JavaScript, dictionaries are called objects, whereas, in languages like Python or C, they are called dictionaries]]
    ...
    - [[./Khoa học máy tính/Lập trình hướng đối tượng/Lớp là một cái khuôn để tạo các đối tượng cho nhanh|Lớp là một cái khuôn để tạo các đối tượng cho nhanh]]
    - [[./Khoa học máy tính/Lập trình hướng đối tượng/JSON là cách để biểu diễn đối tượng ra chữ|JSON là cách để biểu diễn đối tượng ra chữ]]
    - [[./Khoa học máy tính/Lập trình hướng đối tượng/Phương thức là hàm liên quan tới một đối tượng cụ thể|Phương thức là hàm liên quan tới một đối tượng cụ thể]]
    - [[./Khoa học máy tính/Lập trình hướng đối tượng/So sánh giữa các ngôn ngữ|So sánh giữa các ngôn ngữ]]
    - [[./Khoa học máy tính/Lập trình hướng đối tượng/this, self là cách để nói một phương thức rằng hành động nó sẽ làm phải gắn lên một instance cụ thể, thứ mà bây giờ chưa được tạo ra|this, self là cách để nói một phương thức rằng hành động nó sẽ làm phải gắn lên một instance cụ thể, thứ mà bây giờ chưa được tạo ra]]
...
- Khoa học máy tính/Lập trình hướng đối tượng/JavaScript: 
...
- Khoa học máy tính/Lập trình hướng đối tượng/Python: 
    ...
    - [[./Khoa học máy tính/Lập trình hướng đối tượng/Python/Môi trường|Môi trường]]
    - [[./Khoa học máy tính/Lập trình hướng đối tượng/Python/Python không khuyến khích việc đọc kỹ đối tượng để bảo vệ tính toàn vẹn của đối tượng và giảm thiểu khả năng xảy ra lỗi|Python không khuyến khích việc đọc kỹ đối tượng để bảo vệ tính toàn vẹn của đối tượng và giảm thiểu khả năng xảy ra lỗi]]
    - [[./Khoa học máy tính/Lập trình hướng đối tượng/Python/Dictionary là một container chứa và thao tác với dữ liệu, trong khi JSON về bản chất dùng để mã hóa và giải mã dữ liệu|Dictionary là một container chứa và thao tác với dữ liệu, trong khi JSON về bản chất dùng để mã hóa và giải mã dữ liệu]]
...
- Kinh tế học và chủ nghĩa tân tự do. Tâm lý học quản lý và lao động/Kinh tế học, chủ nghĩa tân tự do/Các loại hình kinh tế mới/Nền kinh tế chăm sóc: 
    ...
    - [[./Kinh tế học và chủ nghĩa tân tự do. Tâm lý học quản lý và lao động/Kinh tế học, chủ nghĩa tân tự do/Các loại hình kinh tế mới/Nền kinh tế chăm sóc/Nền kinh tế chăm sóc 1|Nền kinh tế chăm sóc 1]]
...
- Kinh tế học và chủ nghĩa tân tự do. Tâm lý học quản lý và lao động/Kinh tế học, chủ nghĩa tân tự do/Kinh tế học tâm lý: 
    ...
    - [[./Kinh tế học và chủ nghĩa tân tự do. Tâm lý học quản lý và lao động/Kinh tế học, chủ nghĩa tân tự do/Kinh tế học tâm lý/Tiền tạo cảm giác phải cạnh tranh để có tài nguyên hơn là hợp tác|Tiền tạo cảm giác phải cạnh tranh để có tài nguyên hơn là hợp tác]]
    - [[./Kinh tế học và chủ nghĩa tân tự do. Tâm lý học quản lý và lao động/Kinh tế học, chủ nghĩa tân tự do/Kinh tế học tâm lý/Tiền được lưu ở dạng vật chất, nhưng nhu cầu là một trạng thái của con người|Tiền được lưu ở dạng vật chất, nhưng nhu cầu là một trạng thái của con người]]
...
- Kinh tế học và chủ nghĩa tân tự do. Tâm lý học quản lý và lao động/Tâm lý học quản lý và lao động/Kỹ năng, động lực: 
    ...
    - [[./Kinh tế học và chủ nghĩa tân tự do. Tâm lý học quản lý và lao động/Tâm lý học quản lý và lao động/Kỹ năng, động lực/Sự giúp đỡ người khác làm con người câm thấy cuộc sống có ý nghĩa|Sự giúp đỡ người khác làm con người câm thấy cuộc sống có ý nghĩa]]
...
- Nghĩ về việc nghĩ: 
    ...
    - [[./Nghĩ về việc nghĩ/Sự chuyên gia (exertise) đến từ việc nhìn ra mẫu hình (pattern)|Sự chuyên gia (exertise) đến từ việc nhìn ra mẫu hình (pattern)]]
...
- Nghĩ về việc nghĩ/Bản thể luận/Đối tượng: 
    - [[./Nghĩ về việc nghĩ/Bản thể luận/Đối tượng/Hoán dụ giúp ta vẽ được những thứ trừu tượng|Hoán dụ giúp ta vẽ được những thứ trừu tượng]]
    ...
    - [[./Nghĩ về việc nghĩ/Bản thể luận/Đối tượng/Sử dụng nhiều ẩn dụ khác nhau sẽ cho ta thấy đối tượng tốt hơn|Sử dụng nhiều ẩn dụ khác nhau sẽ cho ta thấy đối tượng tốt hơn]]
...
- Nghĩ về việc nghĩ/Hệ phức hợp: 
    ...
    - [[./Nghĩ về việc nghĩ/Hệ phức hợp/Nếu bạn nghĩ rằng bạn có thể hoàn thành đúng kế hoạch, có thể bạn đang có fallacy|Nếu bạn nghĩ rằng bạn có thể hoàn thành đúng kế hoạch, có thể bạn đang có fallacy]]
    - [[./Nghĩ về việc nghĩ/Hệ phức hợp/Sự tự tổ chức|Sự tự tổ chức]]
...
- Nghĩ về việc nghĩ/Học ngoại ngữ: 
    - [[./Nghĩ về việc nghĩ/Học ngoại ngữ/Untitled|Untitled]]
...
- Nghĩ về việc nghĩ/Môi trường nghĩ, nhận thức tăng cường/Đọc và viết/Ghi chú thông tin: 
    ...
    - [[./Nghĩ về việc nghĩ/Môi trường nghĩ, nhận thức tăng cường/Đọc và viết/Ghi chú thông tin/Quản lý tài liệu|Quản lý tài liệu]]
...
- Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức: 
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Dự án chủ yếu là các công việc khám phá. Chương trình chủ yếu là các công việc khai phá|Dự án chủ yếu là các công việc khám phá. Chương trình chủ yếu là các công việc khai phá]]
...
- Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Gây quỹ: 
    ...
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Gây quỹ/Crowdfunding depends on highly visible public work|Crowdfunding depends on highly visible public work]]
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Gây quỹ/Donations for open source lack the urgency and personal empathy that charity causes have|Donations for open source lack the urgency and personal empathy that charity causes have]]
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Gây quỹ/Funder-exclusive writing should be a secondary by-product of primary work|Funder-exclusive writing should be a secondary by-product of primary work]]
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Gây quỹ/Getting Paid for Open Source Work|Getting Paid for Open Source Work]]
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Gây quỹ/Hãy loại bỏ quyền lợi truyền thông tài trợ ra khỏi tài liệu mời tài trợ|Hãy loại bỏ quyền lợi truyền thông tài trợ ra khỏi tài liệu mời tài trợ]]
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Gây quỹ/Kinh nghiệm gây quỹ cho dự án nghiên cứu độc lập|Kinh nghiệm gây quỹ cho dự án nghiên cứu độc lập]]
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Gây quỹ/Nhà đầu tư tìm kiếm tiền trong vụ đầu tư|Nhà đầu tư tìm kiếm tiền trong vụ đầu tư]]
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Gây quỹ/Người ủng hộ trên Patreon ủng hộ vì muốn có được sản phẩm sẽ có trong tương lai, hơn vì muốn trả cho những gì mình đã làm (sản phẩm trong quá khứ)|Người ủng hộ trên Patreon ủng hộ vì muốn có được sản phẩm sẽ có trong tương lai, hơn vì muốn trả cho những gì mình đã làm (sản phẩm trong quá khứ)]]
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Gây quỹ/Nhà đầu tư đầu tư vào việc kinh doanh, không phải ý tưởng|Nhà đầu tư đầu tư vào việc kinh doanh, không phải ý tưởng]]
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Gây quỹ/Patreon không được thiết kế để có được sự tương tác trực tiếp với người ủng hộ|Patreon không được thiết kế để có được sự tương tác trực tiếp với người ủng hộ]]
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Gây quỹ/Patreon vận hành gần giống như một cuộc trao đổi hơn là hoàn toàn ủng hộ|Patreon vận hành gần giống như một cuộc trao đổi hơn là hoàn toàn ủng hộ]]
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Gây quỹ/Văn hoá doanh nghiệp quyết định hiệu quả của việc kinh doanh|Văn hoá doanh nghiệp quyết định hiệu quả của việc kinh doanh]]
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Gây quỹ/Để gọi vốn thì rất cần nắm chắc những con số|Để gọi vốn thì rất cần nắm chắc những con số]]
...
- Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Lên kế hoạch: 
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Lên kế hoạch/Bởi vì sản phẩm có tính quy hồi, nên người làm quản lý dự án phải có biết lập trình để có thể thao tác trên vật một cách hiệu quả|Bởi vì sản phẩm có tính quy hồi, nên người làm quản lý dự án phải có biết lập trình để có thể thao tác trên vật một cách hiệu quả]]
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Lên kế hoạch/Các chỉ số đo lường thu nhập|Các chỉ số đo lường thu nhập]]
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Lên kế hoạch/Các cấp trong tổ chức nên nói chuyện với nhau bằng thành quả|Các cấp trong tổ chức nên nói chuyện với nhau bằng thành quả]]
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Lên kế hoạch/Công việc khai phá và công việc khám phá|Công việc khai phá và công việc khám phá]]
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Lên kế hoạch/Công việc sẽ được gắn ở khắp nơi|Công việc sẽ được gắn ở khắp nơi]]
    ...
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Lên kế hoạch/Giả thiết có mặt ở khắp nơi|Giả thiết có mặt ở khắp nơi]]
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Lên kế hoạch/Hiểu biết không chỉ để mình làm một cái gì đó, mà còn để mình không làm một cái gì đó|Hiểu biết không chỉ để mình làm một cái gì đó, mà còn để mình không làm một cái gì đó]]
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Lên kế hoạch/Knowns and unknowns|Knowns and unknowns]]
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Lên kế hoạch/Lịch|Lịch]]
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Lên kế hoạch/Mọi thành quả mong muốn đều chưa trong mình những giả thuyết|Mọi thành quả mong muốn đều chưa trong mình những giả thuyết]]
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Lên kế hoạch/Một sản phẩm được tạo nên bởi nhiều thành phẩm|Một sản phẩm được tạo nên bởi nhiều thành phẩm]]
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Lên kế hoạch/Một số thành phẩm sẽ có những thành quả mong muốn bên trong nó, nhưng thường chỉ là thành phẩm nhỏ hơn|Một số thành phẩm sẽ có những thành quả mong muốn bên trong nó, nhưng thường chỉ là thành phẩm nhỏ hơn]]
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Lên kế hoạch/Người giúp đỡ sẽ khó có động lực giúp nếu không thấy ý tưởng mình rõ ràng|Người giúp đỡ sẽ khó có động lực giúp nếu không thấy ý tưởng mình rõ ràng]]
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Lên kế hoạch/Nhu cầu là những impact|Nhu cầu là những impact]]
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Lên kế hoạch/Quản lý công việc và quản lý kiến thức không thể tách rời nhau|Quản lý công việc và quản lý kiến thức không thể tách rời nhau]]
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Lên kế hoạch/Sau 2 tuần nên cập nhật những cái mới|Sau 2 tuần nên cập nhật những cái mới]]
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Lên kế hoạch/Sản phẩm là một vật|Sản phẩm là một vật]]
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Lên kế hoạch/Sản phẩm là sự bồi tụ của các dòng hải lưu nhu cầu và kết tinh của kiến thức|Sản phẩm là sự bồi tụ của các dòng hải lưu nhu cầu và kết tinh của kiến thức]]
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Lên kế hoạch/Số lượng vấn đề tìm ra trong 1 buổi có thể nhiều hơn số lượng vấn đề có thể giải quyết trong 1 tháng|Số lượng vấn đề tìm ra trong 1 buổi có thể nhiều hơn số lượng vấn đề có thể giải quyết trong 1 tháng]]
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Lên kế hoạch/Thành phẩm (output) là các kết quả trực tiếp của các công việc|Thành phẩm (output) là các kết quả trực tiếp của các công việc]]
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Lên kế hoạch/Thành quả (outcome) là kết quả mà chúng ta thu được do sự thay đổi về hành vi của người dùng khi tương tác với sản phẩm đã được cải tiến (hoặc sản phẩm mới)|Thành quả (outcome) là kết quả mà chúng ta thu được do sự thay đổi về hành vi của người dùng khi tương tác với sản phẩm đã được cải tiến (hoặc sản phẩm mới)]]
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Lên kế hoạch/Thành quả mong muốn nguyên thuỷ chính là nhu cầu|Thành quả mong muốn nguyên thuỷ chính là nhu cầu]]
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Lên kế hoạch/Thành quả quan trọng hơn thành phẩm|Thành quả quan trọng hơn thành phẩm]]
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Lên kế hoạch/Vấn đề chỉ được phát hiện ra khi đến khâu triển khai ý tưởng|Vấn đề chỉ được phát hiện ra khi đến khâu triển khai ý tưởng]]
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Lên kế hoạch/Working on niche, personally-meaningful projects brings weirder, more serendipitous inbounds|Working on niche, personally-meaningful projects brings weirder, more serendipitous inbounds]]
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Lên kế hoạch/Áp lực giết chết sự sáng tạo|Áp lực giết chết sự sáng tạo]]
    ...
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Lên kế hoạch/Để có thể thiết kế một giải pháp một cách nhanh chóng và tự tin, ta cần được thử nghiệm ý tưởng mới và kiểm trả giả thiết ngay khi chúng vừa được nghĩ ra|Để có thể thiết kế một giải pháp một cách nhanh chóng và tự tin, ta cần được thử nghiệm ý tưởng mới và kiểm trả giả thiết ngay khi chúng vừa được nghĩ ra]]
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Lên kế hoạch/Đừng chạy theo tính năng, mà hãy xác định vấn đề cần ưu tiên giải quyết và nhanh chóng kiểm tra các giả thuyết|Đừng chạy theo tính năng, mà hãy xác định vấn đề cần ưu tiên giải quyết và nhanh chóng kiểm tra các giả thuyết]]
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Lên kế hoạch/❝Mục tiêu❞ và ❝Kết quả❞ là những từ bao trùm|❝Mục tiêu❞ và ❝Kết quả❞ là những từ bao trùm]]

- Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Lên kế hoạch/Sắp xếp độ ưu tiên: 
...
- Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Nghiên cứu: 
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Nghiên cứu/Các nghiên cứu có thể có cùng một mục tiêu nghiên cứu, nhưng khác nhau về câu hỏi nghiên cứu|Các nghiên cứu có thể có cùng một mục tiêu nghiên cứu, nhưng khác nhau về câu hỏi nghiên cứu]]
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Nghiên cứu/Idea là một cái gì đó để thử, còn insight là kết quả của sự thử|Idea là một cái gì đó để thử, còn insight là kết quả của sự thử]]
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Nghiên cứu/Idea với insight đều là một|Idea với insight đều là một]]
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Nghiên cứu/Một số ví dụ về mục tiêu nghiên cứu|Một số ví dụ về mục tiêu nghiên cứu]]
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Nghiên cứu/Nghiên cứu|Nghiên cứu]]
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Nghiên cứu/Những câu hỏi đánh giá tác động đòi hỏi phải nghiên cứu sâu|Những câu hỏi đánh giá tác động đòi hỏi phải nghiên cứu sâu]]
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Nghiên cứu/Phân loại người dùng khi ptsp khác với phân khúc khách hàng|Phân loại người dùng khi ptsp khác với phân khúc khách hàng]]

- Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Nghiên cứu/Các bên liên quan: 
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Nghiên cứu/Các bên liên quan/Biểu đồ cánh hoa phù hợp cho việc phân tích bối cảnh cạnh tranh ở một thị trường mới hoặc resegmented markets|Biểu đồ cánh hoa phù hợp cho việc phân tích bối cảnh cạnh tranh ở một thị trường mới hoặc resegmented markets]]
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Nghiên cứu/Các bên liên quan/Biểu đồ cạnh tranh giúp ta có được những giả định đầu tiên về những khách hàng đầu tiên của chúng ta|Biểu đồ cạnh tranh giúp ta có được những giả định đầu tiên về những khách hàng đầu tiên của chúng ta]]
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Nghiên cứu/Các bên liên quan/Biểu đồ cạnh tranh XY phù hợp cho việc phân tích bối cảnh cạnh tranh trên một thị trường đã có sẵn|Biểu đồ cạnh tranh XY phù hợp cho việc phân tích bối cảnh cạnh tranh trên một thị trường đã có sẵn]]
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Nghiên cứu/Các bên liên quan/Tổng hợp các cách biểu diễn các bên liên quan|Tổng hợp các cách biểu diễn các bên liên quan]]

- Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Nghiên cứu/Khảo sát, phỏng vấn: 
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Nghiên cứu/Khảo sát, phỏng vấn/Khảo sát thường được dùng để kiểm chứng các phát hiện quan trọng có được từ phỏng vấn trên quy mô lớn|Khảo sát thường được dùng để kiểm chứng các phát hiện quan trọng có được từ phỏng vấn trên quy mô lớn]]
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Nghiên cứu/Khảo sát, phỏng vấn/Khảo sát định lượng chỉ có tính chính xác tương đối|Khảo sát định lượng chỉ có tính chính xác tương đối]]
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Nghiên cứu/Khảo sát, phỏng vấn/Kết quả phỏng vấn phải actionable|Kết quả phỏng vấn phải actionable]]
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Nghiên cứu/Khảo sát, phỏng vấn/Luôn nhìn vào hành vi, đừng chỉ nhìn vào logic của người dùng|Luôn nhìn vào hành vi, đừng chỉ nhìn vào logic của người dùng]]
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Nghiên cứu/Khảo sát, phỏng vấn/Một số mục tiêu phỏng vấn gợi ý|Một số mục tiêu phỏng vấn gợi ý]]
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Nghiên cứu/Khảo sát, phỏng vấn/Người thích mình thường có nhu cầu khác về sản phẩm so với người không thích mình|Người thích mình thường có nhu cầu khác về sản phẩm so với người không thích mình]]
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Nghiên cứu/Khảo sát, phỏng vấn/Nên phỏng vấn cả những người không nằm trong nhóm đối tượng mục tiêu của mình|Nên phỏng vấn cả những người không nằm trong nhóm đối tượng mục tiêu của mình]]
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Nghiên cứu/Khảo sát, phỏng vấn/Nên phỏng vấn một tập người dùng nhiều lần, nhưng không nên một người nhiều lần|Nên phỏng vấn một tập người dùng nhiều lần, nhưng không nên một người nhiều lần]]
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Nghiên cứu/Khảo sát, phỏng vấn/Phần lớn các câu hỏi nghiên cứu không thể sử dụng để hỏi trực tiếp|Phần lớn các câu hỏi nghiên cứu không thể sử dụng để hỏi trực tiếp]]
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Nghiên cứu/Khảo sát, phỏng vấn/Phỏng vấn người dùng nên được diễn ra liên tục, tốt nhất là hàng tuần|Phỏng vấn người dùng nên được diễn ra liên tục, tốt nhất là hàng tuần]]
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Nghiên cứu/Khảo sát, phỏng vấn/Phỏng vấn phù hợp để hiểu lý do cho một hành vi của một người|Phỏng vấn phù hợp để hiểu lý do cho một hành vi của một người]]
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Nghiên cứu/Khảo sát, phỏng vấn/Phỏng vấn phù hợp để đánh giá cách tiếp nhận hay thái độ|Phỏng vấn phù hợp để đánh giá cách tiếp nhận hay thái độ]]
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Nghiên cứu/Khảo sát, phỏng vấn/Phỏng vấn thường kém chính xác trong việc dự đoán các hành vi tương lai của người dùng|Phỏng vấn thường kém chính xác trong việc dự đoán các hành vi tương lai của người dùng]]
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Nghiên cứu/Khảo sát, phỏng vấn/Trả tiền cho người phỏng vấn sẽ khiến họ làm việc chuyên nghiệp|Trả tiền cho người phỏng vấn sẽ khiến họ làm việc chuyên nghiệp]]
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Nghiên cứu/Khảo sát, phỏng vấn/Tìm hiểu vào bối cảnh, không chỉ hành vi đơn lẻ|Tìm hiểu vào bối cảnh, không chỉ hành vi đơn lẻ]]

- Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Nghiên cứu/Kiểm định giả thuyết: 
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Nghiên cứu/Kiểm định giả thuyết/Hãy liệt kê những niềm tin trước khi phỏng vấn|Hãy liệt kê những niềm tin trước khi phỏng vấn]]
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Nghiên cứu/Kiểm định giả thuyết/Hệ thống giả thiết ban đầu dễ khiến ta bỏ qua việc kiểm chứng niềm tin, hoặc kiểm chứng bằng những câu hỏi định hướng|Hệ thống giả thiết ban đầu dễ khiến ta bỏ qua việc kiểm chứng niềm tin, hoặc kiểm chứng bằng những câu hỏi định hướng]]
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Nghiên cứu/Kiểm định giả thuyết/Sử dụng nhiều phương pháp khác nhau để kiểm tra giả thuyết sẽ tránh thiên kiến tốt hơn là dùng một phương pháp nhiều lần|Sử dụng nhiều phương pháp khác nhau để kiểm tra giả thuyết sẽ tránh thiên kiến tốt hơn là dùng một phương pháp nhiều lần]]
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Nghiên cứu/Kiểm định giả thuyết/Việc kiểm định giả thuyết thường bị bỏ qua khi có quá nhiều việc|Việc kiểm định giả thuyết thường bị bỏ qua khi có quá nhiều việc]]

- Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Nghiên cứu/Phân tích xu hướng: 
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Nghiên cứu/Phân tích xu hướng/Các mạng xã hội có những báo cáo về xu hướng của người dùng nền tảng của họ|Các mạng xã hội có những báo cáo về xu hướng của người dùng nền tảng của họ]]
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Nghiên cứu/Phân tích xu hướng/Dữ liệu cho dự đoán tin cậy về hành vi người dùng|Dữ liệu cho dự đoán tin cậy về hành vi người dùng]]
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Nghiên cứu/Phân tích xu hướng/Dữ liệu cho ta biết hành vi của một người, nhưng không nói lý do họ làm điều đó|Dữ liệu cho ta biết hành vi của một người, nhưng không nói lý do họ làm điều đó]]

- Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Nghiên cứu/Quản lý dữ liệu: 
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Nghiên cứu/Quản lý dữ liệu/Các tổ chức thường chỉ lưu trữ kiến thức mà ít khi dành nhiều sự chú ý tới kết nối chúng|Các tổ chức thường chỉ lưu trữ kiến thức mà ít khi dành nhiều sự chú ý tới kết nối chúng]]
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Nghiên cứu/Quản lý dữ liệu/Sử dụng phương pháp đánh chỉ số tập tin giúp dễ tìm kiếm (search) hơn là truy cập (navigate)|Sử dụng phương pháp đánh chỉ số tập tin giúp dễ tìm kiếm (search) hơn là truy cập (navigate)]]

- Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Truyền thông, xây dựng cộng đồng: 
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Truyền thông, xây dựng cộng đồng/Phá băng|Phá băng]]
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Truyền thông, xây dựng cộng đồng/Sản phẩm là web thì medium chỉ có social, referral, forum, blog, chat, form|Sản phẩm là web thì medium chỉ có social, referral, forum, blog, chat, form]]
...
- Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Xây dựng, quản lý nhóm: 
    ...
    - [[./Quản lý dự án, phát triển sản phẩm, xây dựng tổ chức/Xây dựng, quản lý nhóm/Các câu chuyện mà  người dùng kể được lấp đầy bởi khoảng trống mà họ kỳ vọng và thế giới|Các câu chuyện mà  người dùng kể được lấp đầy bởi khoảng trống mà họ kỳ vọng và thế giới]]
...
- Ξ Nguồn: 
    - [[./Ξ Nguồn/ABG Open Special 2023|ABG Open Special 2023]]
    - [[./Ξ Nguồn/Andy Matuschak|Andy Matuschak]]
    - [[./Ξ Nguồn/Bing AI|Bing AI]]
    - [[./Ξ Nguồn/Doing project wiki|Doing project wiki]]
    - [[./Ξ Nguồn/Hoàng Đức Minh|Hoàng Đức Minh]]
    - [[./Ξ Nguồn/IBM|IBM]]
    - [[./Ξ Nguồn/Maggie Appleton|Maggie Appleton]]
    - [[./Ξ Nguồn/Phạm Đình Khánh|Phạm Đình Khánh]]
    - [[./Ξ Nguồn/Tạp chí ngân hàng|Tạp chí ngân hàng]]
    - [[./Ξ Nguồn/Tự ngẫm nghĩ|Tự ngẫm nghĩ]]
    - [[./Ξ Nguồn/Veritasium|Veritasium]]
    - [[./Ξ Nguồn/Wikipedia|Wikipedia]]
    - [[./Ξ Nguồn/Đừng bắt tôi nghĩ|Đừng bắt tôi nghĩ]]

- Ξ Nguồn/Tài liệu: 
    - [[./Ξ Nguồn/Tài liệu/Công nghệ thông tin|Công nghệ thông tin]]
    - [[./Ξ Nguồn/Tài liệu/Môi trường nghĩ|Môi trường nghĩ]]
    - [[./Ξ Nguồn/Tài liệu/Sách kinh tế|Sách kinh tế]]
    - [[./Ξ Nguồn/Tài liệu/tuhocict|tuhocict]]
